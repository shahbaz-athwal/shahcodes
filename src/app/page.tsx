  ...
  return (
    <>
      ...
      <section className="my-12">
        ...
        <Link
          href="/techstack"
          className="group bg-zinc-950 dark:bg-zinc-50 dark:hover:bg-zinc-200 hover:bg-zinc-800 transition-colors inline-block mt-8 font-mono text-xs font-semibold rounded-full px-8 py-3 text-white dark:text-black"
        >
          More Information{" "}
