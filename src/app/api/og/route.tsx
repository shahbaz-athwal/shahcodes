...
export const GET = async (request: NextRequest) => {
  ...
  const backgroundData = await readFile(
    join(process.cwd(), "public/opengraph_bg.png"),
  );
  ...
  const geistBold = await readFile(
    join(process.cwd(), "src/app/api/og/Geist-Bold.ttf"),
  );
  const geistRegular = await readFile(
    join(process.cwd(), "src/app/api/og/Geist-Regular.ttf"),
  );
    ...
    <div tw="flex flex-col justify-between w-full h-full relative p-16">
      ...
      <div tw="flex items-center z-10 mt-8">
        ...
        <div tw="flex flex-col ml-6">
          ...
          <div tw="text-[18px] font-normal text-gray-300">
