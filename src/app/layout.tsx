...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body
        className={`${inter.className} antialiased selection:bg-purple-800/90 selection:text-white dark:bg-[#040201] dark:selection:bg-yellow-800/90`}
      >
        ...
        <div className="pointer-events-none absolute inset-0 z-[-10] overflow-hidden">
          <div className="h-full bg-top bg-no-repeat opacity-100 blur dark:bg-[url('/bg-sm-dark.png')] dark:opacity-[0.6] dark:blur-0 sm:h-[80%] sm:bg-[url('/bg-light.jpg')] sm:dark:bg-[url('/bg-dark.jpg')]" />
        </div>
      </body>
    </html>
  );
