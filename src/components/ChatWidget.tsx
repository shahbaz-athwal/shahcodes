        ...
        {!isOpen && (
          ...
          >
            <Button
              onClick={toggleChat}
              size="icon"
              className="h-12 w-12 rounded-full bg-stone-900 text-white shadow-lg transition-all duration-150 hover:bg-stone-800 sm:h-14 sm:w-14 dark:bg-stone-100 dark:text-stone-900 dark:hover:bg-stone-200"
            >
