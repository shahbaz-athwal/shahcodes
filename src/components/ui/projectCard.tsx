...
const ProjectCard = ({ title, description, link, imageSrc, imageAlt}: any) => {
  return (
    <Link href={link} target="_blank" title={title}>
      <div className="flex flex-col h-full space-y-6 rounded-xl mx-2 md:mx-0 p-6 lg:p-8 bg-zinc-100 hover:bg-zinc-200/70 dark:bg-stone-700/30 dark:hover:bg-stone-700/60">
        <div>
