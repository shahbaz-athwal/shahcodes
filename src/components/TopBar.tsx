  ...
  return (
    <>
      <nav className="relative isolate z-10">
        <div
          className={cn(
            "fixed inset-x-0 top-0 mx-auto flex w-full max-w-[45rem] items-center justify-between rounded-br-3xl rounded-bl-3xl border-b border-stone-300 px-6 py-1.5 sm:absolute sm:border-x sm:px-12 sm:py-2.5 dark:border-stone-500/50 dark:text-gray-200"
          )}
        >
